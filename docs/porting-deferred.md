...
last_updated: 2026-05-25 (D291 Bucket A closure — Case 5 + F2 CI guard CLOSED cross-arm; Case 15a PARTIAL — substrate fix landed but cross-arm lift blocked by libuv-async-commit deadlock surfaced during verification; D291 deferred-scope sub-items + D291-async-commit follow-on added below)
---
