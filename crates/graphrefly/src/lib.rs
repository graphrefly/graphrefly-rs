...
pub use patterns::{
    ...
    CollectionEntry, FactId, FactStore, KnowledgeAssertion, KnowledgeAssertionObject, MemoryAnswer,
    MemoryFragment, MemoryFragmentValidation, MemoryQuery, MemoryRetrievalBundle,
...
pub use solutions::{
    agentic_memory_bundle, agentic_memory_context_packing_bundle,
    agentic_memory_kg_projection_bundle, agentic_memory_record_frame,
    agentic_memory_record_frame_codec, agentic_memory_retention_bundle,
    validate_agentic_memory_artifact_kind, validate_agentic_memory_kind,
    ...
    AgenticMemoryBundleOptions, AgenticMemoryConsolidationRequest, AgenticMemoryContext,
    AgenticMemoryContextEntry, AgenticMemoryContextPackingBundle,
    AgenticMemoryContextPackingBundleOptions, AgenticMemoryContextPackingCursor,
    AgenticMemoryContextPackingPolicy, AgenticMemoryContextPackingSnapshot,
    AgenticMemoryContextPackingStatus, AgenticMemoryCursor, AgenticMemoryError,
    AgenticMemoryErrorCode, AgenticMemoryFieldValidation, AgenticMemoryKgAssertionDraft,
    AgenticMemoryKgProjectionBundle, AgenticMemoryKgProjectionBundleOptions,
    AgenticMemoryKgProjectionCursor, AgenticMemoryKgProjectionSnapshot,
    AgenticMemoryKgProjectionStatus, AgenticMemoryKind, AgenticMemoryPackedContext,
    AgenticMemoryPersistenceLevel, AgenticMemoryProjection, AgenticMemoryRecord,
    AgenticMemoryRecordFrame, AgenticMemoryRecordFrameCodec, AgenticMemoryRecordMetadata,
    AgenticMemoryRecordValidation, AgenticMemoryRetentionBundle,
