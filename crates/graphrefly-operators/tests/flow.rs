...
// on one thread") used to be asserted by the deleted `scheduling_groups.rs`
// test file (D253 (S5) deleted the `SchedulingGroupId` surface entirely;
// the single-owner contract is now structural via `Core: !Send + !Sync`).
#[test]
